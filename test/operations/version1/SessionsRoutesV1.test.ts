...
suite('SessionRoutesV1', () => {
    ...
    // test('should have roles and organizations', (done) => {
    //     rest.post('/api/v1/signin',
    //         {
    //             login: TestUsers.AdminUserLogin,
    //             password: TestUsers.AdminUserPassword
    //         },
    //         (err, req, res, session) => {
    //             assert.isNull(err);

    //             // Check user has roles
    //             assert.lengthOf(session.roles, 1);
    //             // Check user has a test organization
    //             assert.lengthOf(session.organizations, 1);
